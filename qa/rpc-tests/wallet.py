...
#   c) node1 mines 32 blocks, so now node 0 has 60001trump, node 1 has 4250trump, node2 has none.
#   d) node0 sends 601 trump to node2, in two transactions (301 trump, then 300 trump).
