Contributing to TrumpCoin Core
============================

The TrumpCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/trumpcoin-project/trumpcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the TrumpCoin Core project, and is not to be
confused with overall TrumpCoin Network Protocol consensus changes.

Whether a pull request is merged into TrumpCoin Core rests with the project merge
...
Patches that change TrumpCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the TrumpCoin consensus, it must have been
...
The project leader is the release manager for each TrumpCoin Core release.
