...
To build TrumpCoin Core using AFL instrumentation (this assumes that the
...
with certain assembly code from TrumpCoin Core's code. See [developer notes on sanitizers](https://github.com/TrumpCoin-Project/TrumpCoin/blob/master/doc/developer-notes.md#sanitizers)
