...
This mechanism has been integrated into Bitcore-Node-TrumpCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TrumpCoin-Project/insight-api-trumpcoin#web-socket-api](https://github.com/TrumpCoin-Project/insight-api-trumpcoin#web-socket-api) 
* API: [https://github.com/TrumpCoin-Project/insight-api-trumpcoin#swifttx-transactions](https://github.com/TrumpCoin-Project/insight-api-trumpcoin#swifttx-transactions) 
...
By default, the TrumpCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TrumpCoin Core daemon:
