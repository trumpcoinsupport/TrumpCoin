...
In order to support loading of multiple wallets in trumpcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trumpcoin.cpp.
...
Changes to trumpcoin.cpp
----------------------
trumpcoin.cpp is the entry point into trumpcoin-qt, and as such, will require some minor modifications to provide hooks for
