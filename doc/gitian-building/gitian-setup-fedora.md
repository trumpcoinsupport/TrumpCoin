...
The build script we'll be using is contained in the TrumpCoin github repository ([contrib/gitian-build.py](https://github.com/trumpcoin-project/trumpcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the TrumpCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/TrumpCoin-Project/TrumpCoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, trumpcoin-detached-sigs, and trumpcoin GitHub repos.
