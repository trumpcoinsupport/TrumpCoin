TrumpCoin Core version v5.1.0 is now available from:  <https://github.com/trumpcoin-project/trumpcoin/releases>
...
- #2218 Guarding wallet access from init and print error for unknown PN collaterals (furszy)
...
### Tier Two Network (Patriotnodes / Budget)
- #2143 [BUG] Fix deadlock in GetNextPatriotnodeInQueueForPayment (random-zebra)
- #2170 Better trumpcoin.conf Patriotnode data error notification (furszy)
- #2186 Improving patriotnode check inputs and add process (furszy)
...
- #2135 [Patriotnode] Manage status cleanup (furszy)
