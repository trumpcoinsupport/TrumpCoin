...
"""
Test checking:
 1) Patriotnode setup/creation.
 2) Tier two network sync (patriotnode broadcasting).
 3) Patriotnode activation.
 4) Patriotnode expiration.
 5) Patriotnode re activation.
 6) Patriotnode removal.
 7) Patriotnode collateral spent removal.
"""
...
class PatriotnodeActivationTest(TrumpCoinTier2TestFramework):
    ...
    def reconnect_and_restart_patriotnodes(self):
    ...
    def run_test(self):
        ...
        self.log.info("patriotnodes expired successfully")

        # check patriotnode removal
        ...
        self.log.info("patriotnodes removed successfully")

        # restart and check spending the collateral now.
        self.reconnect_and_restart_patriotnodes()
        ...
        self.log.info("patriotnode list updated successfully, vin spent")




if __name__ == '__main__':
    PatriotnodeActivationTest().main()
