...
Also test that nodes that send unsupported service bits to trumpcoind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if trumpcoind ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(TrumpCoinTestFramework):
