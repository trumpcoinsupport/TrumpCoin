...
By default, trumpcoind will dump mempool on shutdown and
...
class MempoolPersistTest(TrumpCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent trumpcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
