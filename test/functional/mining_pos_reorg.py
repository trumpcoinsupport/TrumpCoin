...
class ReorgStakeTest(TrumpCoinTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        # verify that nodes have the expected TRUMP supply
    ...
    def run_test(self):
        ...
        # Verify that TRUMP supply was properly updated after the reorgs (including burned fee)
        self.log.info("Check TRUMP supply...")
