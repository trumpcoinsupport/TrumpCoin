...
class ListReceivedTest (TrumpCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 TRUMP.
        ...
        # Send 1 TRUMP to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 TRUMP sending them all (fee is 0.1 TRUMP)
        ...
        # Confirm transaction (2 TRUMP from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 TRUMP, send 0.6 TRUMP + 0.05 TRUMP fee
