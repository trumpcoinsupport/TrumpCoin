...
class GovernanceReorgTest(TrumpCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.mnOneCollateral = self.setupPatriotnode(minerA, minerA, self.patriotnodeOneAlias,
                                                    ownerdir, self.remoteOnePos, self.mnOnePrivkey)
        self.mnTwoCollateral = self.setupPatriotnode(minerA, minerA, self.patriotnodeTwoAlias,
        ...
        mn1.initpatriotnode(self.mnOnePrivkey, "127.0.0.1:"+str(remoteOnePort))
        mn2.initpatriotnode(self.mnTwoPrivkey, "127.0.0.1:"+str(remoteTwoPort))
        self.stake_and_ping(self.minerAPos, 1, [])
        self.wait_until_mnsync_finished()
        self.controller_start_patriotnode(minerA, self.patriotnodeOneAlias)
        self.controller_start_patriotnode(minerA, self.patriotnodeTwoAlias)
        ...
        minerA.mnbudgetvote("alias", proposalHash, "yes", self.patriotnodeOneAlias)
        minerA.mnbudgetvote("alias", proposalHash, "yes", self.patriotnodeTwoAlias)
        time.sleep(1)
