#!/usr/bin/env python3
# Copyright (c) 2020 The TrumpCoin Core developers
...
class SaplingMempoolTest(TrumpCoinTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 TRUMP note to Alice
        ...
        # miner sends another 10 TRUMP note to Alice
