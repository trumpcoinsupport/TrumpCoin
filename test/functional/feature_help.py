...
"""Verify that starting trumpcoin with -h works as expected."""
...
class HelpTest(TrumpCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start trumpcoin with -? for help text")
        ...
        self.log.info("Start trumpcoin with -version for version information")
