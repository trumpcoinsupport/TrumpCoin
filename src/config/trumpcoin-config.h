/* src/config/trumpcoin-config.h.  Generated from trumpcoin-config.h.in by configure.  */
/* src/config/trumpcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TRUMP_CONFIG_H

#define TRUMP_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.trumpcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TrumpCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TrumpCoin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "trumpcoin"
