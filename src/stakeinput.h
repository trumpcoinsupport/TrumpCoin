...
#ifndef TrumpCoin_STAKEINPUT_H
#define TrumpCoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZTRUMP() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zTRUMPStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked ztrump, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZTRUMP() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZTRUMP() override { return false; }
};


#endif //TrumpCoin_STAKEINPUT_H
