...
enum ServiceFlags : uint64_t {
    ...
    // that the node doesn't want to receive patriot nodes messages. (the 1<<3 was not picked as constant because on bitcoin 0.14 is witness and we want that update here )
