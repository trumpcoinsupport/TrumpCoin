...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TrumpCoin features */
        {"trumpcoin", "patriotnode", &patriotnode, true, true, false},
        {"trumpcoin", "listpatriotnodes", &listpatriotnodes, true, true, false},
        {"trumpcoin", "getpatriotnodecount", &getpatriotnodecount, true, true, false},
        {"trumpcoin", "patriotnodeconnect", &patriotnodeconnect, true, true, false},
        {"trumpcoin", "createpatriotnodebroadcast", &createpatriotnodebroadcast, true, true, false},
        {"trumpcoin", "decodepatriotnodebroadcast", &decodepatriotnodebroadcast, true, true, false},
        {"trumpcoin", "relaypatriotnodebroadcast", &relaypatriotnodebroadcast, true, true, false},
        {"trumpcoin", "patriotnodecurrent", &patriotnodecurrent, true, true, false},
        {"trumpcoin", "patriotnodedebug", &patriotnodedebug, true, true, false},
        {"trumpcoin", "startpatriotnode", &startpatriotnode, true, true, false},
        {"trumpcoin", "createpatriotnodekey", &createpatriotnodekey, true, true, false},
        {"trumpcoin", "getpatriotnodeoutputs", &getpatriotnodeoutputs, true, true, false},
        {"trumpcoin", "listpatriotnodeconf", &listpatriotnodeconf, true, true, false},
        {"trumpcoin", "getpatriotnodestatus", &getpatriotnodestatus, true, true, false},
        {"trumpcoin", "getpatriotnodewinners", &getpatriotnodewinners, true, true, false},
        {"trumpcoin", "getpatriotnodescores", &getpatriotnodescores, true, true, false},
        {"trumpcoin", "mnbudget", &mnbudget, true, true, false},
        {"trumpcoin", "preparebudget", &preparebudget, true, true, false},
        {"trumpcoin", "submitbudget", &submitbudget, true, true, false},
        {"trumpcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"trumpcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"trumpcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"trumpcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"trumpcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"trumpcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"trumpcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"trumpcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"trumpcoin", "mnsync", &mnsync, true, true, false},
        {"trumpcoin", "spork", &spork, true, true, false},
        {"trumpcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getztrumpseed", &getztrumpseed, false, false, true},
        {"zerocoin", "setztrumpseed", &setztrumpseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdztrump", &searchdztrump, false, false, true},
        {"zerocoin", "dztrumpstate", &dztrumpstate, false, false, true}
