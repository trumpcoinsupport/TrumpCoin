...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total trumpcoin balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in trumpcoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in trumpcoin/kb\n"
    ...
    UniValue ztrumpObj(UniValue::VOBJ);
...
UniValue mnsync(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1 || (strMode != "status" && strMode != "reset")) {
        throw runtime_error(
            ...
            "  \"lastPatriotnodeList\": xxxx,        (numeric) Timestamp of last MN list message\n"
            "  \"lastPatriotnodeWinner\": xxxx,      (numeric) Timestamp of last MN winner message\n"
            "  \"lastBudgetItem\": xxxx,            (numeric) Timestamp of last MN budget message\n"
            "  \"lastFailure\": xxxx,           (numeric) Timestamp of last failed sync\n"
            "  \"nCountFailures\": n,           (numeric) Number of failed syncs (total)\n"
            "  \"sumPatriotnodeList\": n,        (numeric) Number of MN list messages (total)\n"
            "  \"sumPatriotnodeWinner\": n,      (numeric) Number of MN winner messages (total)\n"
            ...
            "  \"countPatriotnodeList\": n,      (numeric) Number of MN list messages (local)\n"
            "  \"countPatriotnodeWinner\": n,    (numeric) Number of MN winner messages (local)\n"
    ...
    if (strMode == "status") {
        ...
        obj.push_back(Pair("IsBlockchainSynced", patriotnodeSync.IsBlockchainSynced()));
        obj.push_back(Pair("lastPatriotnodeList", patriotnodeSync.lastPatriotnodeList));
        obj.push_back(Pair("lastPatriotnodeWinner", patriotnodeSync.lastPatriotnodeWinner));
        obj.push_back(Pair("lastBudgetItem", patriotnodeSync.lastBudgetItem));
        obj.push_back(Pair("lastFailure", patriotnodeSync.lastFailure));
        obj.push_back(Pair("nCountFailures", patriotnodeSync.nCountFailures));
        obj.push_back(Pair("sumPatriotnodeList", patriotnodeSync.sumPatriotnodeList));
        obj.push_back(Pair("sumPatriotnodeWinner", patriotnodeSync.sumPatriotnodeWinner));
        obj.push_back(Pair("sumBudgetItemProp", patriotnodeSync.sumBudgetItemProp));
        obj.push_back(Pair("sumBudgetItemFin", patriotnodeSync.sumBudgetItemFin));
        obj.push_back(Pair("countPatriotnodeList", patriotnodeSync.countPatriotnodeList));
        obj.push_back(Pair("countPatriotnodeWinner", patriotnodeSync.countPatriotnodeWinner));
        obj.push_back(Pair("countBudgetItemProp", patriotnodeSync.countBudgetItemProp));
        obj.push_back(Pair("countBudgetItemFin", patriotnodeSync.countBudgetItemFin));
        obj.push_back(Pair("RequestedPatriotnodeAssets", patriotnodeSync.RequestedPatriotnodeAssets));
        obj.push_back(Pair("RequestedPatriotnodeAttempt", patriotnodeSync.RequestedPatriotnodeAttempt));
...
UniValue getstakingstatus(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"mnsync\": true|false,             (boolean) if patriotnode data is synced\n"
            "  \"staking status\": true|false,     (boolean) if the wallet is staking or not\n"
            "}\n"
    ...
    obj.push_back(Pair("mnsync", patriotnodeSync.IsSynced()));
