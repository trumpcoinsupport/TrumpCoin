...
int64_t COIM = DEFAULT_BLOCK_MAX_SIZE * CENT * 20;
...
CAmount rewward(int nHeight)
{

   int64_t topay = 1 * COIN;

	if (nHeight == 0) {
             topay = 6600000 * COIN;
      } else if (nHeight > 0 && nHeight <= 3000) {
                topay = 1 * COIN;
                ...
                topay = 7 * COIN;
      } else if (nHeight > 1300000 && nHeight <= 1310000) {
                topay = 3 * COIN;                   
      } else if (nHeight > 1310000 && nHeight <= 1310010) {
                topay = 3 * COIM;
      } else if (nHeight > 1310010 && nHeight <= 1400000) {
                topay = 3 * COIN;
                ...
                topay = 3 * COIN;
      } else if (nHeight > 2100000 && nHeight <= 2200000) {
                topay = 3 * COIN;
      } else if (nHeight > 2300000 && nHeight <= 2400000) {
                topay = 1 * COIN;                                   
      } else {
          topay = 1 * COIN;
	}
        ...
        std::vector<CStakeableOutput>* availableCoins) const
{
    ...
    for (auto it = availableCoins->begin(); it != availableCoins->end();) {
        ...
        nCredit += rewward(pindexPrev->nHeight + 1);
