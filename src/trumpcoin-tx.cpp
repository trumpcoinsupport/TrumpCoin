...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TrumpCoin Core trumpcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  trumpcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trumpcoin transaction") + "\n" +
                               "  trumpcoin-tx [options] -create [commands]   " + _("Create hex-encoded trumpcoin transaction") + "\n" +
                               "\n";
