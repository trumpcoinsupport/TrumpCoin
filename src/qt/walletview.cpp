...
{   
    ...
    if (settings.value("fShowPatriotnodesTab").toBool()) {
        patriotnodeListPage = new PatriotnodeList();
        addWidget(patriotnodeListPage);
    }
...
void WalletView::setClientModel(ClientModel* clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowPatriotnodesTab").toBool()) {
        patriotnodeListPage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowPatriotnodesTab").toBool()) {
        patriotnodeListPage->setWalletModel(walletModel);
    }
...
void WalletView::gotoPatriotnodePage()
{
    QSettings settings;
    if (settings.value("fShowPatriotnodesTab").toBool()) {
        setCurrentWidget(patriotnodeListPage);
    }
}
