...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeTrumpCoinAmount") || reset)
        gArgs.SoftSetArg("-anonymizetrumpcoinamount", settings.value("nAnonymizeTrumpCoinAmount").toString().toStdString());
