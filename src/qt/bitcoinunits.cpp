...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TRUMP);
    unitlist.append(mTRUMP);
    unitlist.append(uTRUMP);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case TRUMP:
        return QString("trumpcoin");
    case mTRUMP:
        return QString("mtrumpcoin");
    case uTRUMP:
        return QString::fromUtf8("utrumpcoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZTRUMP)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZTRUMP);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZTRUMP)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZTRUMP));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
