...
#ifndef TrumpCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define TrumpCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //TrumpCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
