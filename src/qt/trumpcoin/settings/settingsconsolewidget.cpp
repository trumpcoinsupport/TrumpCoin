...
#include "qt/trumpcoin/settings/settingsconsolewidget.h"
#include "qt/trumpcoin/settings/forms/ui_settingsconsolewidget.h"
...
SettingsConsoleWidget::SettingsConsoleWidget(TrumpCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(RPCExecutor::CMD_REPLY, (tr("Welcome to the TrumpCoin RPC console.") + "<br>" +
