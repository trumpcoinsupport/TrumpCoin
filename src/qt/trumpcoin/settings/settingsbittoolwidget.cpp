...
#include "qt/trumpcoin/settings/settingsbittoolwidget.h"
#include "qt/trumpcoin/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(TrumpCoinGUI* _window, QWidget *parent) :
