...
#include "qt/trumpcoin/settings/settingswalletrepairwidget.h"
#include "qt/trumpcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/trumpcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(TrumpCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to TrumpCoinGUI::handleRestart()
