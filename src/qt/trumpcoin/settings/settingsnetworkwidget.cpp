...
#include "qt/trumpcoin/settings/settingsnetworkwidget.h"
#include "qt/trumpcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/trumpcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(TrumpCoinGUI* _window, QWidget *parent) :
