...
#include "qt/trumpcoin/settings/settingsbackupwallet.h"

#include "qt/trumpcoin/settings/forms/ui_settingsbackupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(TrumpCoinGUI* _window, QWidget *parent) :
