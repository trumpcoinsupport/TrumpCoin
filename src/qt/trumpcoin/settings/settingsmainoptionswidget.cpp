...
#include "qt/trumpcoin/settings/settingsmainoptionswidget.h"
#include "qt/trumpcoin/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(TrumpCoinGUI* _window, QWidget *parent) :
