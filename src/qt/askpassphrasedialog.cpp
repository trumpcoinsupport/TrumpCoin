...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            TrumpCoinGUI* window = static_cast<TrumpCoinGUI*>(parentWidget());
...
{
    TrumpCoinGUI* gui = static_cast<TrumpCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<TrumpCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("%1 will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your TRUMPs from being stolen by malware infecting your computer.").arg(PACKAGE_NAME) +
            "<br><br><b>" +
