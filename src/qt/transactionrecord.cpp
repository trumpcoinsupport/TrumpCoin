...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->ztrumpTracker->HasMintTx(hash))) {
            //zTRUMP stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZTRUMP;
...
bool IsZTRUMPType(TransactionRecord::Type type)
{
    switch (type) {
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZTRUMP || type == TransactionRecord::MNReward) {
