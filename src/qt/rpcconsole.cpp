...
void RPCConsole::setClientModel(ClientModel* model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        connect(model, &ClientModel::strPatriotnodesChanged, this, &RPCConsole::setPatriotnodeCount);
...
void RPCConsole::clear()
{
    ...
    message(RPCExecutor::CMD_REPLY, (tr("Welcome to the TrumpCoin RPC console.") + "<br>" +
...
void RPCConsole::showPNConfEditor()
{
    GUIUtil::openPNConfigfile();
}
