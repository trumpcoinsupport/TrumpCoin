...
void ClientModel::updateTimer()
{
    ...
    if (cachedNumBlocks != newNumBlocks ||
        ...
        patriotnodeSync.RequestedPatriotnodeAttempt != prevAttempt || patriotnodeSync.RequestedPatriotnodeAssets != prevAssets) {
        cachedNumBlocks = newNumBlocks;
        cachedReindexing = fReindex;
        cachedImporting = fImporting;
        prevAttempt = patriotnodeSync.RequestedPatriotnodeAttempt;
        prevAssets = patriotnodeSync.RequestedPatriotnodeAssets;
...
void ClientModel::updateMnTimer()
{
    ...
    if (cachedPatriotnodeCountString != newPatriotnodeCountString) {
        ...
        emit strPatriotnodesChanged(cachedPatriotnodeCountString);
    }
}
