...
#include "net.h"    // validatePatriotnodeIP
#include "netbase.h"
#include "protocol.h"
#include "serialize.h"
#include "streams.h"
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:15110", "127.0.0.1", 15110));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:15110", "127.0.0.1", 15110));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:15110", "::ffff:127.0.0.1", 15110));
    BOOST_CHECK(TestSplitHost("[::]:15110", "::", 15110));
    BOOST_CHECK(TestSplitHost("::15110", "::15110", -1));
    BOOST_CHECK(TestSplitHost(":15110", "", 15110));
    BOOST_CHECK(TestSplitHost("[]:15110", "", 15110));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:15110", "127.0.0.1:15110"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:15110", "[::]:15110"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
BOOST_AUTO_TEST_CASE(validate_test)
{
    ...
    for (const std::string& ipStr : validIPv4)
        BOOST_CHECK_MESSAGE(validatePatriotnodeIP(ipStr), ipStr);
