...
extern UniValue setztrumpseed(const UniValue& params, bool fHelp);
extern UniValue getztrumpseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdztrump(const UniValue& params, bool fHelp);
extern UniValue dztrumpstate(const UniValue& params, bool fHelp);
...
extern UniValue getpoolinfo(const UniValue& params, bool fHelp); // in rpcpatriotnode.cpp
extern UniValue patriotnode(const UniValue& params, bool fHelp);
extern UniValue listpatriotnodes(const UniValue& params, bool fHelp);
extern UniValue getpatriotnodecount(const UniValue& params, bool fHelp);
extern UniValue createpatriotnodebroadcast(const UniValue& params, bool fHelp);
extern UniValue decodepatriotnodebroadcast(const UniValue& params, bool fHelp);
extern UniValue relaypatriotnodebroadcast(const UniValue& params, bool fHelp);
extern UniValue patriotnodeconnect(const UniValue& params, bool fHelp);
extern UniValue patriotnodecurrent(const UniValue& params, bool fHelp);
extern UniValue patriotnodedebug(const UniValue& params, bool fHelp);
extern UniValue startpatriotnode(const UniValue& params, bool fHelp);
extern UniValue createpatriotnodekey(const UniValue& params, bool fHelp);
extern UniValue getpatriotnodeoutputs(const UniValue& params, bool fHelp);
extern UniValue listpatriotnodeconf(const UniValue& params, bool fHelp);
extern UniValue getpatriotnodestatus(const UniValue& params, bool fHelp);
extern UniValue getpatriotnodewinners(const UniValue& params, bool fHelp);
extern UniValue getpatriotnodescores(const UniValue& params, bool fHelp);

extern UniValue mnbudget(const UniValue& params, bool fHelp); // in rpcpatriotnode-budget.cpp
