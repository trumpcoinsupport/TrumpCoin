...
protected:
    ...
    virtual void NotifyPatriotnodeListChanged(bool undo, const CDeterministicPNList& oldPNList, const CDeterministicPNListDiff& diff) {}
};
...
public:
    ...
    void NotifyPatriotnodeListChanged(bool undo, const CDeterministicPNList& oldPNList, const CDeterministicPNListDiff& diff);
};
