...
public:
    ...
    /** The patriotnode count that we will allow the see-saw reward payments to be off by */
    int PatriotnodeCountDrift() const { return nPatriotnodeCountDrift; }
    ...
    /** Spork key and Patriotnode Handling **/
    ...
    int64_t StartPatriotnodePayments() const { return nStartPatriotnodePayments; }
...
protected:
    ...
    int64_t nStartPatriotnodePayments;
