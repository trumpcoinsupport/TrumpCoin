...
const char* PNBROADCAST = "mnb";
const char* PNBROADCAST2 = "mnb2"; // BIP155 support
const char* PNPING = "mnp";
const char* PNWINNER = "mnw";
const char* GETPNWINNERS = "mnget";
...
const static std::string allNetMessageTypes[] = {
    ...
    "mnq",
    NetMsgType::PNBROADCAST,
    NetMsgType::PNPING,
    "dstx",  // deprecated
    NetMsgType::GETPNWINNERS,
    NetMsgType::GETPNLIST,
    NetMsgType::BUDGETVOTESYNC,
    NetMsgType::GETSPORKS,
    NetMsgType::SYNCSTATUSCOUNT,
    NetMsgType::PNBROADCAST2
};
...
bool CInv::IsPatriotNodeType() const{
     return type > 2;
}
...
std::string CInv::GetCommand() const
{
    ...
    switch (type) {
        ...
        case MSG_PATRIOTNODE_WINNER: return cmd.append(NetMsgType::PNWINNER);
        case MSG_PATRIOTNODE_SCANNING_ERROR: return cmd.append("mnodescanerr"); // Deprecated
        ...
        case MSG_PATRIOTNODE_QUORUM: return cmd.append("mnq"); // Unused
        case MSG_PATRIOTNODE_ANNOUNCE: return cmd.append(NetMsgType::PNBROADCAST); // or PNBROADCAST2
        case MSG_PATRIOTNODE_PING: return cmd.append(NetMsgType::PNPING);
