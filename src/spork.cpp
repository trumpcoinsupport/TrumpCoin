...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_8_PATRIOTNODE_PAYMENT_ENFORCEMENT,  4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_9_PATRIOTNODE_BUDGET_ENFORCEMENT,   4070908800ULL), // OFF
    ...
    MAKE_SPORK_DEF(SPORK_21_LEGACY_PNS_MAX_HEIGHT,          4070908800ULL), // OFF
};
