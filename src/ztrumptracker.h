...
#ifndef TrumpCoin_ZTRUMPTRACKER_H
#define TrumpCoin_ZTRUMPTRACKER_H
...
public:
    CzTRUMPTracker(std::string strWalletFile);
    ~CzTRUMPTracker();
...
#endif //TrumpCoin_ZTRUMPTRACKER_H
