...
#ifndef PATRIOTNODE_BUDGET_H
#define PATRIOTNODE_BUDGET_H
...
public:
    ...
    std::map<uint256, CBudgetProposalBroadcast> mapSeenPatriotnodeBudgetProposals;
    std::map<uint256, CBudgetVote> mapSeenPatriotnodeBudgetVotes;
    std::map<uint256, CBudgetVote> mapOrphanPatriotnodeBudgetVotes;
    ...
    void ClearSeen()
    {
        mapSeenPatriotnodeBudgetProposals.clear();
        mapSeenPatriotnodeBudgetVotes.clear();
    ...
    void Clear()
    {
        ...
        mapSeenFinalizedBudgets.clear();
        mapSeenFinalizedBudgetVotes.clear();
        mapOrphanPatriotnodeBudgetVotes.clear();
    ...
    inline void SerializationOp(Stream& s, Operation ser_action, int nType, int nVersion)
    {
        READWRITE(mapSeenPatriotnodeBudgetProposals);
        READWRITE(mapSeenPatriotnodeBudgetVotes);
        READWRITE(mapSeenFinalizedBudgets);
        READWRITE(mapSeenFinalizedBudgetVotes);
        READWRITE(mapOrphanPatriotnodeBudgetVotes);
...
public:
    ...
    void AutoCheck();
    //total trumpcoin paid out by this budget
    CAmount GetTotalPayout();
    //vote on this finalized budget as a patriotnode
    void SubmitVote();
